...
partial class PySR
{
    ...
    public const string Runtime_RaiseStmt_CauseNonException = "exception causes must derive from BaseException";
    ...
    public const string Runtime_Object_FormatGroupingBoth = "Cannot specify both ',' and '_'.";
    ...
    public const string Runtime_Object_FormatZNegCoercionNotAllowedInt = "Negative zero coercion (z) not allowed in integer format specifier";
    public const string Runtime_Object_FormatPrecisionNotAllowedInt = "Precision not allowed in integer format specifier";
    ...
    public const string Runtime_Tuple_TakesNoKwargs = "tuple() takes no keyword arguments";
    public const string Runtime_Tuple_ExpectedAtMostOne = "tuple expected at most 1 argument, got {0}";

    public const string Runtime_List_TakesNoKwargs = "list() takes no keyword arguments";
    ...
    public const string Runtime_AsyncGen_IgnoredGeneratorExit = "async generator ignored GeneratorExit";
