...
public static class PySpecialNames
{
    ...
    public const string Call = "__call__";
    public const string GetAttribute = "__getattribute__";
    public const string GetAttr = "__getattr__";
    public const string SetAttr = "__setattr__";
    public const string DelAttr = "__delattr__";
    ...
    public const string DivMod = "__divmod__";
