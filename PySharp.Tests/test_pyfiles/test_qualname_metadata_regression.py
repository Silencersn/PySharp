"""
Regression: qualified names and creation metadata.
...
class Plain:
    pass
assert Plain.__firstlineno__ == 170
...
class Deco:
    pass
assert Deco.__firstlineno__ == 177
...
print("test_qualname_metadata_regression passed")
