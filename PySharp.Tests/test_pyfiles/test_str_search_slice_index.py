"""str search-method start/end bounds go through CPython's _PyEval_SliceIndex: None keeps defaults, anything with __index__ converts, and everything else raises the slice-indices TypeError.
...
print("test_str_search_slice_index passed")
