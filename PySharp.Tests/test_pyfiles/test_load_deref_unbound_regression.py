"""
Regression: the by-name deref path (inline comprehensions per PEP 709 and
...
# must catch it (the type divergence this regression pins).
def case3():
    try:
        r = [late for _ in [1]]
...
print("test_load_deref_unbound_regression passed")
