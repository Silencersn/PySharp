"""str subclass instances keep their subclass type — construction retags a fresh copy — so subclass methods resolve, overrides win and instance dicts work, while str() and str operations convert back to exact str.

bytes/float/tuple subtype construction copies for subtypes too and never
retypes shared instances process-wide.
...
print("test_str_subclass passed")
