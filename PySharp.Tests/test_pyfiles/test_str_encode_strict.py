"""str.encode is strict by default: unencodable code points raise UnicodeEncodeError with CPython's codec name, position run and reason, and the surrogateescape/surrogatepass handlers work.
...
print("test_str_encode_strict passed")
