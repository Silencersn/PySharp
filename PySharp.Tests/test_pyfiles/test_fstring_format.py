...
# TODO: format spec ' x' (space + hex) not yet fully implemented
# assert f'{123: x}' == ' 7b'
# TODO: uppercase hex formatting not yet fully implemented
# assert f'{123:X}' == '7B'
# TODO: alternate form (#) for hex/binary/octal not yet fully implemented
# assert f'{123:#x}' == '0x7b'
# assert f'{123:#X}' == '0X7B'
...
# TODO: various float format specs not yet fully implemented
