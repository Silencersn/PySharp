"""tuple() and str() construct without arguments like the other containers, str grows the bytes-decoding form, and bad arity, keywords or encodings raise CPython's exact TypeError/LookupError messages.
...
print("test_tuple_str_noarg passed")
