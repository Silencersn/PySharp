"""Verifies open() accepts the buffering=, encoding=, errors= and newline= parameters with CPython's argument-check order, lazy error-handler resolution, codec-specific BOM handling, and per-method error messages (issue #236).
