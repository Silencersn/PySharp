...
public sealed class TestPyFiles
{
    ...
    {
        var module = PyInterpreter.RunFile(Path.Combine(PyFilesPath, "test_float.py"));
        Assert.IsNotNull(module);
    }
    ...
    {
        var module = PyInterpreter.RunFile(Path.Combine(PyFilesPath, "test_int_parse.py"));
        Assert.IsNotNull(module);
    }
    ...
    {
        var module = PyInterpreter.RunFile(Path.Combine(PyFilesPath, "test_slice.py"));
        Assert.IsNotNull(module);
    }
    ...
    {
        var module = PyInterpreter.RunFile(Path.Combine(PyFilesPath, "test_iter.py"));
        Assert.IsNotNull(module);
    }
