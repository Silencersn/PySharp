...
public class PyTypeGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
            ...
            .ForAttributeWithMetadataName(
                ...
                transform: static (generatorContext, _) =>
                {
                    ...
                    if (pyTypeConstructorAttribute is not null)
                    {
                        ...
                        accessModifier = pyTypeConstructorAttribute.GetNamedArgumentLiteralOrDefault("AccessModifier", "\"private\"");
                    }
        ...
        context.RegisterSourceOutput(provider, (spc, pyType) =>
        {
            ...
            builder.AppendLine("using PySharp.Modules.Builtins;");
            ...
            if (!pyType.DoNotGenerateConstructor)
            {
                var accessMod = pyType.AccessModifier.Trim('"');
                if (string.IsNullOrEmpty(accessMod)) accessMod = "private";

                builder
                    .AppendLine($"{accessMod} {pyType.Name}()")
                    .EnterBlock()
                    .ExitBlock()
